...
public class ProdukTest {
    ...
    @Test
    @DisplayName("Test setKode")
    void testSetKode() {
        produk.setKode("NEWCODE");
        assertEquals("NEWCODE", produk.getKode());
    }

    @Test
    @DisplayName("Test setNama")
    void testSetNama() {
        produk.setNama("Nama Baru");
        assertEquals("Nama Baru", produk.getNama());
    }

    @Test
    @DisplayName("Test setKategori")
    void testSetKategori() {
        produk.setKategori("Olahraga");
        assertEquals("Olahraga", produk.getKategori());
    }

    @Test
    @DisplayName("Test setHarga")
    void testSetHarga() {
        produk.setHarga(99999.99);
        assertEquals(99999.99, produk.getHarga(), 0.01);
    }
    ...
    void testToString() {
        ...
        assertTrue(result.contains("Produk"));
